...
Feature: Brainstorming
  ...
  @WEAVIN-BrainStorming-0011
  Scenario: Ajouter un vote avec les deux choix
 ...
 #Etape2  : Ajout vote ou un sondage
    ...
    And pause 5 secondes
    And l utilisateur saisit "Ajouter un vote avec les deux choix" dans le champs "Champ_Input_Titre_BrainStorming"
    And pause 5 secondes
