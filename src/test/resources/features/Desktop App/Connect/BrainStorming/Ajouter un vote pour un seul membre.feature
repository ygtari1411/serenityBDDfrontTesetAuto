...
Feature: Brainstorming - Ajouter un vote pour un seul membre
  ...
  @WEAVIN-BrainStorming-0010
  Scenario: Ajouter un vote pour un seul membre
 ...
 #Etape2  : Ajout vote ou un sondage
    ...
    And pause 5 secondes
    And l utilisateur saisit "Ajouter un vote pour un seul membre" dans le champs "Champ_Input_Titre_BrainStorming"
    And pause 5 secondes
    ...
    And pause 5 secondes
    And l utilisateur clique sur "Bouton_Ajouter_Menbre_BrainStorming"
    And pause 5 secondes
