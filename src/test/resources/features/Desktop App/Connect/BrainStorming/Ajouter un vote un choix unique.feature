...
Feature: Brainstorming - Ajouter un vote a choix unique

  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-BrainStorming
  @WEAVIN-BrainStorming-0001
  Scenario: Ajouter un vote a choix unique
 ...
 #Etape2  : Ajout vote ou un sondage
    ...
    And pause 5 secondes
    And l utilisateur saisit "ajouter un vote a choix unique" dans le champs "Champ_Input_Titre_BrainStorming"
    And pause 5 secondes
