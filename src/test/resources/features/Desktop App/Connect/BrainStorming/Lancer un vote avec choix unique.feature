...
Feature: Brainstorming - lancer un vote avec choix unique
  ...
  @WEAVIN-BrainStorming-0005
  Scenario: lancer un vote avec choix unique
 ...
 #Etape2  : Ajout vote ou un sondage
    ...
    And pause 5 secondes
    And l utilisateur saisit "lance un vote avc choix unique" dans le champs "Champ_Input_Titre_BrainStorming"
    And pause 5 secondes
