...
Feature: Brainstorming
  ...
  @WEAVIN-BrainStorming-0007
  Scenario: Repondre a un vote a choix unique
 ...
 #Etape2  : Ajout vote ou un sondage
    ...
    And pause 5 secondes
    And l utilisateur saisit "Repondre a un vote a choix unique" dans le champs "Champ_Input_Titre_BrainStorming"
    And pause 5 secondes
