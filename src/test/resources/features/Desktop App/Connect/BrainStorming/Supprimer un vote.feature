...
Feature: Brainstorming - Supprimer un vote
  ...
  @WEAVIN-BrainStorming-0004
  Scenario: Supprimer un vote
 ...
 #Etape2  : Ajout vote ou un sondage
    ...
    And pause 5 secondes
    And l utilisateur saisit "Supprimer un vote" dans le champs "Champ_Input_Titre_BrainStorming"
    And pause 5 secondes
