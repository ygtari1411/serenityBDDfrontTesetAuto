...
Feature: BubbleStore - Desactiver google drive
  ...
  #Etape2  : Désactiver one drive
    ...
    And pause 10 secondes
    And l utilisateur clique sur "Bouton_Configurer_one_drive"
    And pause 10 secondes
    And l utilisateur clique sur "Bouton_Desactiver_one_drive"

  #Etape3: Verfier que one drive est désactivé
