...
# Scénario: Accepter un évènement avec formulaire d'inscription pour utilisateur interne
# Date de création: 25/05/2021


Feature: Calendrier & évenements - Accepter un évènement avec formulaire d'inscription pour utilisateur interne

  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-CALENDRIER&EVENEMENTS
  @WEAVIN-CALENDRIER&EVENEMENTS-0018
  Scenario: Accepter un évènement avec formulaire d'inscription pour utilisateur interne
    ...
    And l utilisateur saisit "Test automatique Acceptation evenement avec formulaire d'inscription pour utilisateur interne" dans le champs "Champ_Input_Titre_Evenement"
    And l utilisateur saisit "C'est un test automatique de Accepter d'un evenement avec formulaire d'inscription pour utilisateur interne" dans le champs "Champ_Input_Description_Evenement"
    ...
    #Etape 5 : Le premier utilisateur verifier l'acceptation de l'evenement
