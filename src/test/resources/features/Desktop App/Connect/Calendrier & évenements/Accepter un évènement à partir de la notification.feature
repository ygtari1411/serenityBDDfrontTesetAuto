...
# Scénario: Accepter un évènement à partir de la notification
# Date de création: 29/04/2021


Feature: Calendrier & évenements - Accepter un évènement à partir de la notification

  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-CALENDRIER&EVENEMENTS
  @WEAVIN-CALENDRIER&EVENEMENTS-0013
  Scenario: Accepter un évènement à partir de la notification
    ...
    And l utilisateur saisit "Test automatique Accepter un évènement à partir de la notification" dans le champs "Champ_Input_Titre_Evenement"
    And l utilisateur saisit "C'est un test automatique de l'Acceptation d'un évènement à partir de la notification" dans le champs "Champ_Input_Description_Evenement"
