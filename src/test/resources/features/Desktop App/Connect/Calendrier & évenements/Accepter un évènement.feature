...
# Scénario: Accepter un évènement
# Date de création: 27/04/2021


Feature: Calendrier & évenements - Accepter un évènement

  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-CALENDRIER&EVENEMENTS
  @WEAVIN-CALENDRIER&EVENEMENTS-0011
  Scenario: Accepter un évènement
    ...
    And l utilisateur saisit "Test automatique Accepter un évènement" dans le champs "Champ_Input_Titre_Evenement"
    And l utilisateur saisit "C'est un test automatique de l'Acceptation d'un évènement" dans le champs "Champ_Input_Description_Evenement"
