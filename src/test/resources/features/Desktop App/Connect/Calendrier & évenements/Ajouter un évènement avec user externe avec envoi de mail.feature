...
# Scénario: Ajouter un évènement avec user externe avec envoi de mail
# Date de création: 22/04/2021

Feature: Calendrier & évenements - Ajouter un évènement avec user externe avec envoi de mail

  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-CALENDRIER&EVENEMENTS
  @WEAVIN-CALENDRIER&EVENEMENTS-0009
  Scenario: Ajouter un évènement avec user externe avec envoi de mail
