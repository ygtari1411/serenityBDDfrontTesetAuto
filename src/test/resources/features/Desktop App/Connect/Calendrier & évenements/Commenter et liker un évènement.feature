...
# Scénario: Commenter et liker un évènement
# Date de création: 16/02/2021


Feature: Calendrier & évenements - Commenter et liker un évènement

  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-CALENDRIER&EVENEMENTS
  @WEAVIN-CALENDRIER&EVENEMENTS-0003
  Scenario: Commenter et liker un évènement
    ...
    And l utilisateur saisit "Test automatique Commenter et liker un evenement" dans le champs "Champ_Input_Titre_Evenement"
    And l utilisateur saisit "C'est un test automatique Commenter et liker un evenement" dans le champs "Champ_Input_Description_Evenement"
