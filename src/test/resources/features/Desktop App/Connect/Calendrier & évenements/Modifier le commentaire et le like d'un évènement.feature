...
# Scénario:Modifier le  Commentaire et le  like d un évènement
# Date de création: 17/02/2021


Feature: Calendrier & évenements - Modifier le  Commentaire et le  like d un évènement

  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-CALENDRIER&EVENEMENTS
  @WEAVIN-CALENDRIER&EVENEMENTS-0004
  Scenario: Modifier le  Commentaire et le  like d un évènement
    ...
    And l utilisateur saisit "Test automatique Modifier le  Commentaire et le  like d un évènement" dans le champs "Champ_Input_Titre_Evenement"
    And l utilisateur saisit "C'est un test automatique Modifier le  Commentaire et le  like d un évènement" dans le champs "Champ_Input_Description_Evenement"
