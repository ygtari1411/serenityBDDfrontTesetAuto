...
# Scénario: Modifier un évènement
...
Feature: Calendrier & évenements
  ...
  @WEAVIN-CALENDRIER&EVENEMENTS-0002
  Scenario: Modifier un évènement
    ...
    And pause 5 secondes
    And l utilisateur selectionne "PRIVATE" dans la liste deroulante "Type_Evenement"
    And pause 5 secondes
