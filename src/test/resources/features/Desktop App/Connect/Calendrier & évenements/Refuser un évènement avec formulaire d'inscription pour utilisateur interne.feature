...
# Scénario: Refuser un évènement avec formulaire d'inscription pour utilisateur interne
# Date de création: 25/05/2021


Feature: Calendrier & évenements - Refuser un évènement avec formulaire d'inscription pour utilisateur interne

  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-CALENDRIER&EVENEMENTS
  @WEAVIN-CALENDRIER&EVENEMENTS-0019
  Scenario: Refuser un évènement avec formulaire d'inscription pour utilisateur interne
    ...
    And l utilisateur saisit "Test automatique refus evenement avec formulaire d'inscription pour utilisateur interne" dans le champs "Champ_Input_Titre_Evenement"
    And l utilisateur saisit "C'est un test automatique de refuser d'un evenement avec formulaire d'inscription pour utilisateur interne" dans le champs "Champ_Input_Description_Evenement"
    ...
    #Etape 5 : Le deuxieme utilisateur se connecte  pour refuser l'evenement et remplir le formulaire
