...
Feature: Gestion des utilisateurs
  ...
  @WEAVIN-GESTIONUTILISATEURS-0002
  Scenario: Modifier un compte utilisateur (adresse mail)
  ...
  #Etape 3 : Modifier un utilisateur
    ...
    And pause 5 secondes
    And l utilisateur saisit "muhammadkarim.bennasr@yopmail.com" dans le champs "Champ_Input_Email_Modifier_utilisateur"
    And pause 5 secondes
