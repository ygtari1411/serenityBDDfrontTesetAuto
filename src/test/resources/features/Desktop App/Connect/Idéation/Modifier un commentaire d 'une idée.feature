...
Feature: Idéation
  ...
  Scenario: Commenter et Liker une idée
    ...
    When l utilisateur clique sur "Bouton_Modifier_Commentaire_Ideation"
    And l utilisateur modifie "commentaire modifiée" dans le champs "Champ_Input_Commenter_Ideation"
    And l utilisateur clique sur "Bouton_Like_Ideation"
