...
Feature: Idéation
  ...
  Scenario: Modifier un commentaire d'un idée
    ...
    When l utilisateur saisit "test automatisé modifier un commentaire d'une idee6" dans le champs "Titre_nouvelle_idee"
    And l utilisateur saisit "idée_test_auto" dans le champs "Tag_nouvelle_idee"
    And l utilisateur saisit "Ceci est la description de l'idée publiée par un test auto6" dans le champs "Description_nouvelle_idee"
    ...
    And l utilisateur saisit "test automatisé modifier un commentaire d'une idee6" dans le champs "Champ_Input_Rechercher_Ideation_Par_Titre"
    ...
    And l utilisateur saisit "test automatisé modifier un commentaire d'une idee6" dans le champs "Champ_Input_Commenter_Ideation"
    ...
    And l utilisateur clique sur "Bouton_Like_Ideation"
    And l utilisateur modifie le type de reaction
    Then verifier que la modifictaion a été effectuée avec succés
