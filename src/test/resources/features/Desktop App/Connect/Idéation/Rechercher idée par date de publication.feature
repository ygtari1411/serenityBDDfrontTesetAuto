# Auteur: ygtari
# Feature: Idéation
# Scénario: Rechercher idée par date de publication
...
Feature: Idéation
  ...
  @WEAVIN-CONNECT
  @WEAVIN-IDEATION
  @WEAVIN-IDEATION-0010
  Scenario: Rechercher idée par date de publication
    ...
    When l utilisateur saisit "Rechercher idéation par date de publication" dans le champs "Titre_nouvelle_idee"
