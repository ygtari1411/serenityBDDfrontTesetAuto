# Auteur: ygtari
# Feature: Idéation
# Scénario: Rechercher idée par tag
# Date de création: 27/12/2020



Feature: Idéation - Rechercher idée par tag

  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-IDEATION
  @WEAVIN-IDEATION-0011
  Scenario: Rechercher idée par tag
    ...
    When l utilisateur saisit "Rechercher idéation par tag" dans le champs "Titre_nouvelle_idee"
    ...
    #Etape 4 : Rechercher idéation par tag

    When l utilisateur selectionne "idée_test_auto" dans la liste deroulante "Liste_Deroulante_Tags_Ideation"
    And pause 5 secondes
    Then vérifier que les idées affichées contiennent le tag"idée_test_auto"
