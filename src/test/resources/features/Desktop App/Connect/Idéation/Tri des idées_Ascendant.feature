# Auteur: ygtari
# Feature: Idéation
# Scénario: Tri des idées : Ascendant :Par Note
...
Feature: Idéation - Tri des idées : Ascendant :Par Note
  ...
  @WEAVIN-CONNECT
  @WEAVIN-IDEATION
  @WEAVIN-IDEATION-0013
  Scenario: Tri des idées : Ascendant :Par Note
    ...
    When l utilisateur saisit "Tri des idées : Ascendant" dans le champs "Titre_nouvelle_idee"
    ...
    And pause 10 secondes
    And l utilisateur selectionne "Ascendant" dans la liste deroulante "Liste_Deroulante_Tri_ASC_DES"
    And pause 10 secondes
