# Auteur: BenYedder
# Feature: Article
# Scénario: Recherche d'un article par date de début
# Date de création: 29/01/2020




Feature: Article - Recherche d'un article par date de début


  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-KnowStore
  @WEAVIN-KnowStore-0008
  Scenario: Recherche d'un article par date de début
  ...
  #Etape2  : Ajout Article
    ...
    And l utilisateur saisit "Rechercher par date de début" dans le champs "Champ_Input_Titre_Article"
    ...
    And l utilisateur saisit "C'est un test automatique recherche d'un article par date de début" dans le champs "Champ_Input_Description_Article"
    And pause 10 secondes
    ...
    #Etape 4 : Rechercher article par date de début
