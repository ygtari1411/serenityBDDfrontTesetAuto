# Auteur: ygtari
# Feature: Article
# Scénario: Recherche d'un article par date de fin
# Date de création: 02/02/2021




Feature: Article - Recherche d'un article par date de fin


  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-KnowStore
  @WEAVIN-KnowStore-0010
  Scenario: Recherche d'un article par date de fin
  ...
  #Etape2  : Ajout Article
    ...
    And l utilisateur saisit "Rechercher par date de fin" dans le champs "Champ_Input_Titre_Article"
    ...
    And l utilisateur saisit "C'est un test automatique recherche d'un article par date de fin" dans le champs "Champ_Input_Description_Article"
    And pause 10 secondes
    ...
    #Etape 4 : Rechercher article par date de fin

    When l utilisateur clique sur "Calendrier_recherche_article_par_date_Fin"
