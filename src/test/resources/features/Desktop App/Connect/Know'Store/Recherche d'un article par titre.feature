# Auteur: YGtari
# Feature: Article
# Scénario: Recherche d'un article par titre
# Date de création: 13/01/2020




Feature: Article - Recherche d'un article par titre


  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-KnowStore
  @WEAVIN-KnowStore-0007
  Scenario: Recherche d'un article par titre
  ...
  #Etape2  : Ajout Article
    ...
    And l utilisateur saisit "Rechercher par titre" dans le champs "Champ_Input_Titre_Article"
    ...
    #Etape 4 : Rechercher article par titre

    And l utilisateur saisit "Rechercher par titre" dans le champs "Champ_Input_Rechercher_Article_Par_titre"
    And pause 10 secondes
