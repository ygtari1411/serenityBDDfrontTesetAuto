  ...
  Scenario: Création nouvelle news avec heure de début
   ...
   #Etape2  : Ajout News
     ...
     And l utilisateur saisit "09/11/2020" dans le champs "Champ_Input_Date_News"
      And l utilisateur saisit "12:02" dans le champs "Champ_Input_Heure_Debut_News"
    ...
    #Etape 3 : Vérification de la création de la News
     ...
     Then Vérifier que l'actualité ne s'affiche que si l'heure du système est égale à l'heure de date de début de l'actualité
