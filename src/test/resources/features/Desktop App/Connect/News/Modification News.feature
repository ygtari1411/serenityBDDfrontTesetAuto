...
Feature: News
  ...
  #Etape2  : Ajout News
    ...
    And l utilisateur saisit "Test automatique de la création d'une news" dans le champs "Champ_Input_Titre_News"
    And l utilisateur saisit "C'est un test automatique de la création d'une news" dans le champs "Champ_Input_Description_News"
