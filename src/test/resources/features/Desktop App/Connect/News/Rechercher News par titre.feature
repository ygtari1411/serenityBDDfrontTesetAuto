...
Feature: News
  ...
  #Etape2  : Ajout News
   ...
   #When l utilisateur clique sur "Bouton_ouvrir_menu_gauche"
    ...
    And l utilisateur saisit "Test automatique rechercher news par titre" dans le champs "Champ_Input_Titre_News"
    And l utilisateur saisit "C'est un test automatique de la recherche de news par titre" dans le champs "Champ_Input_Description_News"
