# Auteur: YGtari
# Feature: News
# Scénario: Rechercher News par statut non publié
...
Feature: News
  ...
  Scenario: Rechercher News par statut non publié
  ...
  #Etape2  : Ajout News
    ...
    And l utilisateur saisit "Test automatique de la recherche news par statut non publié" dans le champs "Champ_Input_Titre_News"
    And l utilisateur saisit "C'est un test automatique de la recherche d 'une news par statut non publié" dans le champs "Champ_Input_Description_News"
