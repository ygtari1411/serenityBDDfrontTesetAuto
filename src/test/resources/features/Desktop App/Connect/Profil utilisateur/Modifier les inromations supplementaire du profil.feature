...
Feature: Profil utilisateur - Modifier une information supplementaire

  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-PROFILUTILISATEUR
  @WEAVIN-PROFILUTILISATEUR-0032
  Scenario: Modifier une information supplementaire
 ...
 #Etape 4 : Modifier une information supplementaire
