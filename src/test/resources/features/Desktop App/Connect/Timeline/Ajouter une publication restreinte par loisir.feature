# Auteur: ygtari
# Feature: Timeline
# Scénario: Ajouter une publication restreinte par loisir
# Date de création: 14/10/2020



Feature: Timeline - Ajouter une publication restreinte par loisir

  @WEAVIN
  @WEAVIN-CONNECT
  @WEAVIN-TIMELINE
  @WEAVIN-TIMELINE-0023
  Scenario: Ajouter une publication restreinte par loisir
